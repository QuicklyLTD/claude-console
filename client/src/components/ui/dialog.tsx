...
>(({ className, hideClose, children, ...props }, ref) => {
  // Blur the currently focused element before Radix applies aria-hidden on the
  // outer root. Otherwise modern Chromium warns: "Blocked aria-hidden on an
  // element because its descendant retained focus." The composer textarea
  // typically holds focus when a canUseTool modal opens.
  React.useEffect(() => {
